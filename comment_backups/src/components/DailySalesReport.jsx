...
// logs: array of log objects saved by SELL_STORE / SELL_WAREHOUSE actions
export default function DailySalesReport({ logs = [] }) {
  ...
  // Convert a log entry to UZS. Prefer explicit log.total_uzs if present.
                      ...
                      <React.Fragment key={idx}>
                        <ListItem sx={{ py: 1 }}>
                          ...
                          <Box sx={{ ml: 2, textAlign: 'right' }}>
                              ...
                              {/* show per-unit price on mobile: use unitPrice if present or derive from amount/qty */}
