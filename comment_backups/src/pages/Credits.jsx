...
export default function Credits() {
  ...
  // Determine permissions from state.accounts when available (case-insensitive)
  ...
  const handleAdd = (payload) => {
    ...
    // Compute both USD and UZS amounts for accurate logs and avoid mislabeling
    let amountUsd = null
    let amountUzs = null
  ...
  // (permission already determined above using accounts from state)
  ...
  <Box sx={{ width: '100%', px: { xs: 2, sm: 2, md: 0 } }}>
      ...
      <Card>
        <CardContent>
          ...
          {/* Mobile: card grid to avoid horizontal scroll */}
